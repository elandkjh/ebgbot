...
require('./bundle-BimZhXdJ.js');
var consts = require('./bundle-COzM5cWS.js');
var useSendbirdStateContext = require('../useSendbirdStateContext.js');
require('./bundle-5SGoePaQ.js');
...
var VoiceRecorderProvider = function (props) {
    ...
    React.useEffect(function () {
        if (isVoiceMessageEnabled && !webAudioUtils) {
            Promise.resolve().then(function () { return require('./bundle-BzEWSzXp.js'); }).then(function (module) { return setWebAudioUtils(module); });
        }
...
//# sourceMappingURL=bundle-BCx4TP9R.js.map
