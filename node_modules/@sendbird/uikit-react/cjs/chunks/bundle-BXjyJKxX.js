...
const createMessageTemplate = (opts) => {
    ...
    const MessageTemplateBase = ({ templateItems, parentLayout = defaultProperties.box.layout, isRoot = false, }) => {
        ...
        return (React__default.default.createElement(React__default.default.Fragment, null, renderItems.map((item, index, siblings) => {
            ...
            switch (item.type) {
                ...
                case exports.CompositeComponentType.Carousel: {
                    ...
                    return (React__default.default.createElement(renderer.carouselView, Object.assign({}, item, props), item.items.map((items, index) => (React__default.default.createElement(MessageTemplateBase, { key: index, templateItems: items || [], parentLayout: parentLayout })))));
                }
                case ComponentType.Box: {
                    return (React__default.default.createElement(renderer.box, Object.assign({}, item, props),
                        React__default.default.createElement(MessageTemplateBase, { templateItems: item.items || [], parentLayout: item.layout })));
                }
                case ComponentType.Text: {
                    return React__default.default.createElement(renderer.text, Object.assign({}, item, props));
                }
                case ComponentType.Image: {
                    return React__default.default.createElement(renderer.image, Object.assign({}, item, props));
                }
                case ComponentType.TextButton: {
                    return React__default.default.createElement(renderer.textButton, Object.assign({}, item, props));
                }
                case ComponentType.ImageButton: {
                    return React__default.default.createElement(renderer.imageButton, Object.assign({}, item, props));
                }
                default: {
    ...
    return {
        MessageTemplate: ({ parentLayout = defaultProperties.rootLayout, templateVersion, templateItems, }) => {
            ...
            return (React__default.default.createElement(SizeContextProvider, null,
                React__default.default.createElement(Container, { className: isCarousel ? 'sb-message-template__parent_for_carousel' : '' },
                    React__default.default.createElement(MessageTemplateBase, { parentLayout: parentLayout, templateItems: items, isRoot: true }))));
        },
        MessageTemplateBase,
    };
};
...
const Carousel = React__default.default.memo(({ children, gap = GAP_DEFAULT }) => {
    ...
    return (React__default.default.createElement("div", { ref: carouselRef, onMouseDown: handleMouseDown, onMouseMove: handleMouseMove, onMouseUp: handleMouseUp, onMouseLeave: handleMouseUp, onTouchStart: handleTouchStart, onTouchMove: handleTouchMove, onTouchEnd: handleTouchEnd, className: "sb-message-template__carousel", style: {
        ...
        } }, children.map((item, index) => (React__default.default.createElement(CarouselItem, { key: index + '', item: item, defaultWidth: defaultItemWidth + 'px', marginRight: index < children.length - 1 ? gap : undefined })))));
});
...
const useMessageContext = () => React__default.default.useContext(MessageContext);
...
const ActionHandler = ({ className = '', style, children, props }) => {
    ...
    return (React__default.default.createElement("div", { ref: elemRef, className: `${className}${borderClass} ${(props === null || props === void 0 ? void 0 : props.action) ? 'sb-message-template__action' : ''}`, "data-sb-template-id": props.elementId, style: wrapperStyles, onClick: onClick },
...
function renderText(view) {
    ...
    if (isMultiLine || isToBeWrapped) {
        ...
        return (React__default.default.createElement("div", { style: wrapperStyling }, isMultiLine ? React__default.default.createElement("div", { style: webkitLineClampStyles(maxTextLines) }, convertedText) : convertedText));
    }
    return isMultiLine ? React__default.default.createElement("div", { style: webkitLineClampStyles(maxTextLines) }, convertedText) : convertedText;
}
const renderer = createRenderer({
    views: {
        ...
        textButton(props) {
            return (React__default.default.createElement(ActionHandler, { className: "sb-message-template__text-button", elementId: props.elementId, style: props.parsedProperties, props: props }, renderText(Object.assign({ maxTextLines: 1 }, props))));
        },
        imageButton(props) {
            var _a;
        ...
        carouselView(props) {
            return React__default.default.createElement(Carousel, { gap: props.spacing }, props.children);
        },
    },
});
...
//# sourceMappingURL=bundle-BXjyJKxX.js.map
