...
var utils = require('../chunks/bundle-DIWdCgyY.js');
var LocalizationContext = require('../chunks/bundle-BZCLEq3c.js');
var index = require('../chunks/bundle-Cf7poviO.js');
var MediaQueryContext = require('../chunks/bundle-DW5WyVEg.js');
var useLongPress = require('../chunks/bundle-CteyVr3n.js');
var index$2 = require('../chunks/bundle-D58niGxd.js');
var tokenize = require('../chunks/bundle-B0yVr4jS.js');
var utils$1 = require('../chunks/bundle-BsUVmQmx.js');
...
function OpenChannelOGMessage(_a) {
    ...
    var _g = React.useContext(UserProfileContext.UserProfileContext), disableUserProfile = _g.disableUserProfile, renderUserProfile = _g.renderUserProfile;
        ...
        React__default.default.createElement("div", _tslib.__assign({ className: _tslib.__spreadArray(_tslib.__spreadArray([], (Array.isArray(className) ? className : [className]), true), [
            ...
            React__default.default.createElement("div", { className: "sendbird-openchannel-og-message__bottom" },
                React__default.default.createElement("div", { className: "sendbird-openchannel-og-message__bottom__og-tag", ref: mobileMenuRef },
                    ...
                    (ogMetaData === null || ogMetaData === void 0 ? void 0 : ogMetaData.url) && (React__default.default.createElement("div", { className: "sendbird-openchannel-og-message__bottom__og-tag__thumbnail", role: "button", onClick: openLink, onKeyDown: openLink, tabIndex: 0 }, defaultImage && (React__default.default.createElement(ui_ImageRenderer.default, { className: "sendbird-openchannel-og-message__bottom__og-tag__thumbnail__image", url: defaultImage.url || '', alt: defaultImage.alt || '', height: "189px", defaultComponent: (React__default.default.createElement("div", { className: "sendbird-openchannel-og-message__bottom__og-tag__thumbnail__image--placeholder" },
