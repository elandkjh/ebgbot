...
var ui_MessageTemplate = require('../chunks/bundle-BXjyJKxX.js');
...
function TemplateMessageItemBody(_a) {
    ...
    var _j = React.useState(getFilledMessageTemplateItems()), renderData = _j[0], setRenderData = _j[1];
    ...
    return (React__default.default.createElement("div", { className: index.getClassName([
        ...
        React__default.default.createElement(MessageTemplateErrorBoundary, { fallbackMessage: React__default.default.createElement(ui_FallbackTemplateMessageItemBody_tsx.FallbackTemplateMessageItemBody, { className: className, message: message, isByMe: isByMe }), onTemplateMessageRenderedCallback: onTemplateMessageRenderedCallback, isComposite: renderData.isComposite, logger: logger },
            React__default.default.createElement(MessageTemplateWrapper, { message: message, templateVersion: (_c = renderData.templateVersion) !== null && _c !== void 0 ? _c : 0, templateItems: renderData.filledMessageTemplateItemsList }))));
}
