...
var ui_Modal = require('./chunks/bundle-BCx4TP9R.js');
var cssVars = require('css-vars-ponyfill');
var index = require('./chunks/bundle-E1Tkj9Pc.js');
var actionTypes = require('./chunks/bundle-C_QuzoFd.js');
var useMarkAsDeliveredScheduler = require('./chunks/bundle-DeDM8_tg.js');
...
var index$1 = require('./chunks/bundle-C3xjGT8g.js');
...
var stringSet = require('./chunks/bundle-CqS517qU.js');
...
var SendbirdSDK = function (_a) {
    ...
    var _u = React.useState(LoggerFactory(logLevel)), logger = _u[0], setLogger = _u[1];
    var pubSub = React.useState(function () { return customPubSub !== null && customPubSub !== void 0 ? customPubSub : index$1.pubSubFactory(); })[0];
    var _v = React.useReducer(reducer$2, initialState$2), sdkStore = _v[0], sdkDispatcher = _v[1];
    var _w = React.useReducer(reducer$1, initialState$1), userStore = _w[0], userDispatcher = _w[1];
    var _x = React.useReducer(reducer, initialState), appInfoStore = _x[0], appInfoDispatcher = _x[1];
    var _y = uikitTools.useUIKitConfig(), configs = _y.configs, configsWithAppAttr = _y.configsWithAppAttr, initDashboardConfigs = _y.initDashboardConfigs;
    ...
    var _1 = React.useState(theme), currentTheme = _1[0], setCurrentTheme = _1[1];
    React.useEffect(function () {
