...
var ChannelSettingsProvider = function (_a) {
    ...
    return (React__default.default.createElement(ChannelSettingsContext.Provider, { value: {
        ...
        React__default.default.createElement(UserProfileContext.UserProfileProvider, { renderUserProfile: renderUserProfile, disableUserProfile: disableUserProfile !== null && disableUserProfile !== void 0 ? disableUserProfile : !config.common.enableUsingDefaultUserProfile, onUserProfileMessage: onUserProfileMessage },
