...
export declare const MenuItemAction: ({ useAccordion, accordionOpened, children, }: MenuItemActionProps) => string | number | boolean | React.JSX.Element | Iterable<React.ReactNode>;
