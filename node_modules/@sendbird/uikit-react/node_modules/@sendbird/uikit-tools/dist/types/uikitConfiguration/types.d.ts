...
export interface SBUConfigRemote {
    ...
    groupChannel: Omit<GroupChannelConfig, 'channel'> & {
        channel: Omit<GroupChannelConfig['channel'], 'typingIndicatorTypes' | 'enableFeedback' | 'enableSuggestedReplies' | 'showSuggestedRepliesFor' | 'suggestedRepliesDirection' | 'enableMarkdownForUserMessage'>;
    };
    openChannel: OpenChannelConfig;
}
